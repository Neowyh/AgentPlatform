#!/usr/bin/env python3
"""iDeer Interactive Setup Wizard.
...
def main() -> int:
    try:
        ...
        print()
        print(bold("Welcome to iDeer Setup!"))
        print("This wizard will help you configure iDeer in a few minutes.")
        print()
        ...
        print(f"  {cyan('make dev')}        # Start iDeer")
        print()
