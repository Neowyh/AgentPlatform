...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="ideer.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="ideer.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="ideer.community.firecrawl.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="ideer.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="ideer.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="ideer.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
]
