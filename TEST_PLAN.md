...
- [x] **B7a** — 核心 E2E（14 个文件）— ⏭️ 跳过
- [x] **B7b** — QA E2E（11 个文件）— ⏭️ 跳过
- [x] **B7c** — Stagehand（3 个文件）— ⏭️ 跳过
- [x] **B7d** — Visual + A11y（4 个文件）— ⏭️ 跳过

> B7 跳过说明：190 passed / 88 failed，失败均为 locator not found（前端页面渲染与测试预期不匹配）。需全栈环境人工分析，留待后续独立处理。
