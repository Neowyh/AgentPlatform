...
assert_selection true "backend/packages/harness/deerflow/persistence/engine.py"
assert_selection true "backend/packages/harness/deerflow/agents/memory/manager.py"
assert_selection true "backend/packages/harness/deerflow/skills/loader.py"
assert_selection true "backend/app/agentplatform/resources/service.py"
assert_selection true "backend/app/agentplatform/workflows/v2/worker.py"
assert_selection true "backend/packages/agentplatform-extension/agentplatform_extension/evidence.py"
assert_selection true "backend/app/gateway/routers/resources.py"
