...
| Local Runtime client | `local-runtime/core/transport.py` | `LocalRuntimeClient` | Outbound WebSocket HELLO, capability updates, and signed echo/file-read execution |
