...
> status: archived; current change evidence: `docs/archive/`
...
### 2. `backend/packages/harness/ideer/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/ideer/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_ideer_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "iDeer GitHub Repository", "url": "https://github.com/bytedance/ideer", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
