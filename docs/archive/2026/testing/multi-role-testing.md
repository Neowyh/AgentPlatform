...
> audience: testers, security reviewers<br>
> status: archived<br>
> owner: test maintainers<br>
> last-verified: 2026-07-15<br>
> canonical-path: `docs/archive/2026/testing/multi-role-testing.md`

> 本文保留历史 QA 测试说明。原文引用的 `backend/tests/qa/` 已退出默认测试体系；当前测试责任以[测试覆盖矩阵](../../../testing/coverage-matrix.md)和[测试迁移账本](../../../testing/test-migration-ledger.md)为准。
...
- [权限模型](../../../permission-model-redesign.md)
- [权限矩阵](../../../permission-matrix.md)
- [测试覆盖矩阵](../../../testing/coverage-matrix.md)
- [测试迁移账本](../../../testing/test-migration-ledger.md)
