...
| Upload router and middleware regressions | passed | Generic upload path management now uses DeerFlow's manager; enterprise Code Evidence remains separate; 118 focused tests passed after updating the stale exception fixture. |
...
The branch still has 172 textual `ideer` imports under `backend/app`,
