...
function TokenUsageSummary({
  ...
  return (
    <div
      className={cn(
        "text-muted-foreground border-border/60 mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 border-t pt-2 type-compact",
        className,
      )}
    >
        ...
        {steps.map((step) => (
          ...
          >
            <div className="min-w-0 flex-1 space-y-1">
              <div className="text-foreground flex items-center gap-2 type-compact font-medium">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {step.secondaryLabels.map((label, index) => (
                    <Badge
                      ...
                      className="px-1.5 py-0 type-compact font-normal"
                      variant="secondary"
                    >
                      {label}
                    </Badge>
