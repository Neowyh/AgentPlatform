...
export const enUS: Translations = {
  ...
  admin: {
    ...
    departments: {
      ...
      edit: "Edit",
      delete: "Delete",
      memberCount: (count: string) => "{count} members",
      agentCount: (count: string) => "{count} agents",
      skillCount: (count: string) => "{count} skills",
      ...
      reallocDescription: (name, count: string) =>
    ...
    resources: {
      ...
      totalCount: "{total} resources in total",
    ...
    auditLogs: {
      ...
      reset: "Reset",
      totalCount: (total: string) => "{total} records in total",
    ...
    visibilityApplications: {
      ...
      totalCount: (total: string) => "{total} in total",
