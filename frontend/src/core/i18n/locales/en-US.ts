...
export const enUS: Translations = {
  ...
  library: {
    ...
    evalCaseList: {
      ...
      restricted:
        "Read-only account: only knowledge base maintainers can modify eval cases.",
      createTitle: "New eval case",
      questionLabel: "Question",
      questionPlaceholder: "Enter the regression question",
      expectedDocsLabel: "Expected documents",
      expectedDocsEmpty: "This knowledge base has no selectable documents yet",
      tagsLabel: "Tags (comma separated)",
      tagsPlaceholder: "e.g. regression,retrieval",
      create: "Create case",
      creating: "Creating...",
      createFailed:
        "Unable to create the eval case. Check the question, expected documents, and tags.",
      viewDetails: "View details",
      hideDetails: "Hide details",
      ...
      deleteConfirm: "Delete this eval case together with its version history?",
