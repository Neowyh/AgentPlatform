...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    skills: {
      ...
      applyOpen: "申请开放",
      applyOpenTooltip: "申请向部门或全员开放",
      locked: "锁定",
      lockedTooltip: "公开 skill 由管理员控制，用户无法修改",
      applicationSubmitted: "申请已提交",
      applicationSubmitFailed: "提交申请失败",
      applyDialogTitle: "申请开放 Skill: {name}",
      applyDialogDescription:
        "选择开放范围并填写申请理由。部门开放需部门管理员审批，全员开放需超级管理员审批。",
      applyDialogCurrentStatus: "当前状态: private (仅自己可见)",
      applyDialogScope: "申请范围",
      applyDialogScopeDepartment: "部门 (需部门管理员审批)",
      applyDialogScopePublic: "全员 (需超级管理员审批)",
      applyDialogReason: "申请理由",
      applyDialogReasonPlaceholder: "请说明申请开放的原因...",
