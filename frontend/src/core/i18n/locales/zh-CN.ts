...
export const zhCN: Translations = {
  ...
  admin: {
    ...
    departments: {
      ...
      edit: "编辑",
      delete: "删除",
      memberCount: (count: string) => "{count} 成员",
      agentCount: (count: string) => "{count} 智能体",
      skillCount: (count: string) => "{count} 技能",
      createdAt: (date: string) => "创建于 {date}",
    ...
    auditLogs: {
      ...
      endTimeLabel: "结束时间",
      reset: "重置",
      totalCount: (total: string) => "共 {total} 条",
      emptyState: "没有找到审计日志",
      system: "系统",
      resourceLabel: "资源",
      previousPage: "上一页",
