...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes iDeer capable of real action, not just
  conversation.
</Callout>
...
iDeer supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: ideer-sandbox)
...
| `.ideer/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
