---
title: iDeer App
description: iDeer App is the reference implementation of what a production iDeer experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  iDeer App is a complete Super Agent application built on top of iDeer
...
iDeer App is the reference implementation of what a production iDeer experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The iDeer App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, iDeer Harness                               |
| Reverse proxy     | nginx                                                                |
