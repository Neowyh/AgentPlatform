...
description: This tutorial guides you through deploying iDeer to a production environment using Docker Compose for multi-user access.
---
...
This tutorial guides you through deploying iDeer to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.ideer/` directory regularly
