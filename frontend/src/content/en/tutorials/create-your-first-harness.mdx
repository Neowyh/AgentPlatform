...
description: This tutorial shows you how to use the iDeer Harness programmatically — importing and using iDeer directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the iDeer Harness programmatically — importing and using iDeer directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- iDeer repository cloned
