...
<Callout type="info" emoji="📦">
  沙箱是 Agent 进行文件和命令操作的隔离工作区。它让 iDeer
  能够采取真实行动，而不仅仅是对话。
</Callout>
...
安装：`cd backend && uv add 'ideer-harness[aio-sandbox]'`
...
| `.ideer/threads/{thread_id}/user-data/` | `/mnt/user-data/`                             | 读写     |
