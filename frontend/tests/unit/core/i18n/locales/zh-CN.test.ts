...
describe("zhCN locale", () => {
  ...
  describe("workspace", () => {
    ...
    it("has 12 keys", () => {
      expect(Object.keys(zhCN.workspace)).toHaveLength(12);
    });
  });
  ...
  describe("settings", () => {
    ...
    describe("tools", () => {
      ...
      it("has 2 keys", () => {
        expect(Object.keys(zhCN.settings.tools)).toHaveLength(2);
      });
    });
    ...
    describe("skills", () => {
      ...
      it("has 6 keys", () => {
        expect(Object.keys(zhCN.settings.skills)).toHaveLength(6);
      });
    });
