 ...
 * + IDEER_RECORD_OUT in the environment — never run in CI.
 *
  ...
  webServer: [
    {
      ...
      env: {
        ...
        ...(process.env.IDEER_RECORD_OUT
          ? { IDEER_RECORD_OUT: process.env.IDEER_RECORD_OUT }
          : {}),
    ...
    },
    {
      ...
      env: {
        ...
        IDEER_INTERNAL_GATEWAY_BASE_URL: "http://127.0.0.1:8012",
      },
    },
  ],
});
