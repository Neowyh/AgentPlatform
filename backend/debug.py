...
Requirements:
    ...
    resolves the deerflow harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the runtime imports until *after* logging is installed
    # so that any import-time side effects emit logs to debug.log instead of
    # leaking onto the interactive terminal via Python's lastResort handler.
