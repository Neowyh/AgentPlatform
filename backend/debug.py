...
Requirements:
    ...
    resolves ideer-harness and app packages correctly:
...
async def main():
    ...
    # Delay the rest of the ideer imports until *after* logging is installed
    # so that any import-time side effects (e.g. ideer.agents starts a
    ...
    from ideer.mcp import initialize_mcp_tools
