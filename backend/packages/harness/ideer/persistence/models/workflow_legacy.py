"""Read-only ORM boundary for workflow runs created before runtime v2."""
...
class LegacyWorkflowRunRow(Base):
    """Historical v1 data.  The v2 runtime never writes this table."""
