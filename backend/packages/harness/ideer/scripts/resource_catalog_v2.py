"""Audit, migrate, verify, or roll back the canonical resource catalog."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("command", choices=("audit", "migrate", "verify", "rollback"))
    ...
    try:
        async with factory() as session:
            migrator = LegacyResourceMigrator(
                session,
                ResourceStorage(legacy_base_dir),
