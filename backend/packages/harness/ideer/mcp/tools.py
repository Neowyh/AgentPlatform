...
from ideer.mcp.client import build_servers_config
from ideer.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
from ideer.mcp.session_pool import get_session_pool
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as ideer client streams synchronously
