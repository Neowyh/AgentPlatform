...
from ideer.agents.middlewares.summarization_middleware import BeforeSummarizationHook, IDeerSummarizationMiddleware
...
def _create_summarization_middleware(*, app_config: AppConfig | None = None) -> IDeerSummarizationMiddleware | None:
    ...
    # the sole entry point for IDeerSummarizationMiddleware, and the runtime
...
def _create_todo_list_middleware(is_plan_mode: bool) -> TodoMiddleware | None:
    ...
    # Custom prompts matching iDeer's style
    system_prompt = """
<todo_list_system>
...
def _build_middlewares(
    ...
    *,
    ...
    from ideer.agents.middlewares.dynamic_context_middleware import DynamicContextMiddleware
