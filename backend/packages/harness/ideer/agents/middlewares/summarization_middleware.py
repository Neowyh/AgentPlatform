"""Summarization middleware extensions for iDeer."""
...
from ideer.agents.middlewares.dynamic_context_middleware import is_dynamic_context_reminder
from ideer.agents.middlewares.tool_call_metadata import clone_ai_message_with_tool_calls
...
class IDeerSummarizationMiddleware(SummarizationMiddleware):
