...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: ideer-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. ideer.sandbox.local:LocalSandboxProvider)",
    )
