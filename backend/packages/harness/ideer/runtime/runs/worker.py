...
from ideer.runtime.stream_bridge import StreamBridge
from ideer.runtime.user_context import get_effective_user_id
from ideer.tracing import inject_langfuse_metadata
...
async def run_agent(
    ...
    *,
    ...
    try:
        ...
        # Shared helper with ``IDeerClient.stream`` so both entry points stay
        ...
        inject_langfuse_metadata(
            ...
            environment=os.environ.get("IDEER_ENV") or os.environ.get("ENVIRONMENT"),
        )
