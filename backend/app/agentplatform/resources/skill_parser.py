...
fields canonical resource loading must attach, so it is not a drop-in.
"""
...
from app.agentplatform.resources.skill_types import SKILL_MD_FILE, Skill, SkillCategory
