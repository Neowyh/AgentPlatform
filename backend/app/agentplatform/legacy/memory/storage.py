...
class FileMemoryStorage(MemoryStorage):
    ...
    def _get_memory_file_path(self, agent_name: str | None = None, *, user_id: str | None = None) -> Path:
        ...
        if user_id is not None:
            ...
            storage_path = str(legacy_memory_setting(config, "storage_path", ""))
            if storage_path and Path(storage_path).is_absolute():
    ...
    def _load_memory_from_file(self, agent_name: str | None = None, *, user_id: str | None = None) -> dict[str, Any]:
        """Load memory data from the canonical memory file."""
...
def get_memory_storage() -> MemoryStorage:
    ...
    with _storage_lock:
        ...
        config = get_memory_config()
        storage_class_path = str(legacy_memory_setting(config, "storage_class", LEGACY_STORAGE_CLASS))
