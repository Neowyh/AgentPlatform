"""AgentPlatform-owned resource visibility approval models."""
...
class VisibilityApplication(Base):
    """Visibility change application for all canonical resource types."""
    ...
    def validate_visibility(self, key, value):
        ...
        valid_values = {item.value for item in ResourceVisibility}
    ...
    def validate_status(self, key, value):
        valid_values = {item.value for item in VisibilityApplicationStatus}
        if value not in valid_values:
...
__all__ = ["VisibilityApplication", "VisibilityApplicationStatus"]
