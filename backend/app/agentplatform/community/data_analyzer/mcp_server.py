...
Run standalone:
    python -m app.agentplatform.community.data_analyzer.mcp_server
...
Register in extensions_config.json:
  "data-analyzer": {
    ...
    "type": "stdio",
    "command": "python",
    "args": ["-m", "app.agentplatform.community.data_analyzer.mcp_server"]
  }
"""
...
from app.agentplatform.community.data_analyzer import tools as _core
