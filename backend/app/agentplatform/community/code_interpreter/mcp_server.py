...
Run standalone:
    python -m app.agentplatform.community.code_interpreter.mcp_server
...
Register in extensions_config.json:
  "code-interpreter": {
    ...
    "type": "stdio",
    "command": "python",
    "args": ["-m", "app.agentplatform.community.code_interpreter.mcp_server"]
  }
"""
...
from app.agentplatform.community.code_interpreter.tools import _truncate_output
