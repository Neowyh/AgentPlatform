"""AgentPlatform-owned RBAC and visibility models.

These enterprise tables share DeerFlow's declarative base and session engine,
while their lifecycle remains owned by the AgentPlatform control plane.
"""
