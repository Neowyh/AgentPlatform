"""End-to-end demo: SafetyFinishReasonMiddleware on the real iDeer lead-agent.

What it proves
--------------
- The real ``make_lead_agent`` / ``IDeerClient`` pipeline is built (full
...
def main() -> int:
    ...
    # at import time via ``from ideer.models import create_chat_model``,
    ...
    # imported names.
    import ideer.agents.lead_agent.agent as lead_agent_module
    import ideer.client as client_module
