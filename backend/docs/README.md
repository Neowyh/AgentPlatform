...
This directory contains detailed documentation for the iDeer backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs iDeerClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to iDeer?** Start with [SETUP.md](SETUP.md) for quick installation
