...
1. Start iDeer locally using any working development setup you already use.
   ...
   If you already have iDeer running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.ideer/memory.json`
