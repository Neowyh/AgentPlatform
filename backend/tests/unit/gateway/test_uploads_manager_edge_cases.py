"""Tests for uncovered error paths in deerflow.uploads.manager.
...
class TestValidateThreadId:
    ...
    def test_empty_string_raises(self):
        from deerflow.uploads.manager import validate_thread_id
...
class TestOpenUploadPosixOSErrorReRaise:
    ...
    def test_eloop_raises_unsafe_upload(self, tmp_path):
        ...
        from deerflow.uploads.manager import UnsafeUploadPathError, open_upload_file_no_symlink
    ...
    def test_oserror_with_unexpected_errno_is_reraised(self, tmp_path):
        ...
        from deerflow.uploads.manager import open_upload_file_no_symlink
...
class TestOpenUploadWindowsBranch:
    ...
    def _mock_user_context(self):
        ...
        with patch("deerflow.uploads.manager.get_effective_user_id", return_value="testuser"):
            yield
