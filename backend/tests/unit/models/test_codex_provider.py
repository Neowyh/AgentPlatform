"""Tests for ideer.models.openai_codex_provider.CodexChatModel.
...
def _make_model(**kwargs):
    from ideer.models.openai_codex_provider import CodexChatModel

    cred = CodexCliCredential(access_token="tok-test", account_id="acc-test")
    with patch("ideer.models.openai_codex_provider.load_codex_cli_credential", return_value=cred):
