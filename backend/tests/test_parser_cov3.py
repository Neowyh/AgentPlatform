"""Additional tests for packages.harness.ideer.workflows.parser — remaining coverage gaps.

Covers:
  - Line 114: then as dict (StepDef) in _parse_step
  - Line 118: else_ as dict (StepDef) in _parse_step
  - Line 176: _validate_step_references recurse into else_ StepDef
"""
...
# ---------------------------------------------------------------------------
# Lines 114, 118: then/else as dict in _parse_step
# ---------------------------------------------------------------------------
