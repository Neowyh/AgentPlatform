...
from ideer.community.infoquest import tools
from ideer.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("ideer.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("ideer.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/ideerv2/ideer/backend/tests/test_infoquest_client.py
