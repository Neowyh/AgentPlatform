...
from ideer.tools.builtins.tool_search import (
...
class TestToolSearchTool:
    def test_no_registry(self):
        from ideer.tools.builtins.tool_search import tool_search
...
class TestDeferredToolsPromptSection:
    ...
    def _mock_app_config(self, monkeypatch):
        ...
        monkeypatch.setattr("ideer.config.get_app_config", lambda: mock_config)

    def test_empty_when_disabled(self):
        from ideer.agents.lead_agent.prompt import get_deferred_tools_prompt_section
...
class TestDeferredToolFilterMiddleware:
    ...
    def _ensure_middlewares_package(self):
        ...
        That file replaces ideer.agents and ideer.agents.middlewares with
        ...
        mock_keys = [
            ...
            "ideer.agents.middlewares.deferred_tool_filter_middleware",
        ]
