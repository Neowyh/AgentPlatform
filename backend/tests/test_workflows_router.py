...
def _mock_workflow_meta(meta: dict | None = None):
    """Return a patch for _load_workflow_meta that returns the given meta."""
    if meta is None:
