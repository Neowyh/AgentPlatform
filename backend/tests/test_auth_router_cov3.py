"""Additional tests for app.gateway.routers.auth — remaining coverage gaps.

Covers:
  - Line 103: _validate_strong_password returns value for non-common passwords
  - Lines 137-139: _set_session_cookie with HTTPS (max_age set)
  - Line 218: _get_client_ip ValueError in ip_address parsing
  - Lines 406-408: setup_status cache hit inside inflight guard (first check)
"""
...
# ---------------------------------------------------------------------------
# Line 103: _validate_strong_password returns value
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Lines 137-139: _set_session_cookie with HTTPS
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Lines 406-408: setup_status cache hit inside inflight guard
# ---------------------------------------------------------------------------
