...
from ideer.config.app_config import apply_logging_level, logging_level_from_config
...
class TestApplyLoggingLevel:
    """Tests for ``apply_logging_level`` — verifies ideer/app logger and handler levels."""
    ...
    def setup_method(self) -> None:
        ...
        self._original_ideer_level = logging.getLogger("ideer").level
    ...
    def teardown_method(self) -> None:
        ...
        logging.getLogger("ideer").setLevel(self._original_ideer_level)
        logging.getLogger("app").setLevel(self._original_app_level)

    def test_sets_ideer_app_logger_levels(self) -> None:
    ...
    def test_defaults_to_info(self) -> None:
        ...
        assert logging.getLogger("ideer").level == logging.INFO
