...
This project is indexed by GitNexus as **deer-flow** (50777 symbols, 95097 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
