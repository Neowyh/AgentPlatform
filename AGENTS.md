...
This project is indexed by GitNexus as **deer-flow** (50862 symbols, 96204 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
