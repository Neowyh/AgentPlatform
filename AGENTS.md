...
This project is indexed by GitNexus as **deer-flow** (51098 symbols, 96801 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
